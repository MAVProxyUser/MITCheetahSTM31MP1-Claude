/*!
 * @file walk_main.cpp
 * @brief STM32MP1 joint-space WalkController against a Gazebo (Go1) SITL.
 *   walk_sim [peer_ip] [robot_yaml]
 */
#include <string>
#include <cstdio>
...
int main(int argc, char** argv) {
  ...
  printf("[walk] Gazebo SITL | peer=%s robot=%s\n", g_peer.c_str(), robot_yaml.c_str());

  WalkController* ctrl = new WalkController();
