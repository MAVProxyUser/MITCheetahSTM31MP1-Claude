...
- [x] **OPEN-28 closed 2026-09-10 — the harness, not the robot:** loopback-UDP command freezes (now unix datagrams) and host stragglers; wkc_finals at 1.9 24/24. Speed ladder next.
...
- [x] **OPEN-17 closed** — c14 (N=30 interleaved): FORCE_GATE −19 pts
